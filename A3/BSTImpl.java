...
// interface method ==================================================
    public int findMax() {
        /*See BST.java for method specification */
        /* Your code here */
        Node max_cell = findMaxCell(root);
        return max_cell.getValue();
    }
...
// interface method ==================================================
    ...
    public int getMaxLeafHeightDiff () {
        ...
        return leaf_heights(this.root);
    }
    private int leaf_heights(Node c) {
        // private inner "helper" method with different signature
        // this helper method uses recursion to traverse
        // and process the recursive structure of the tree of cells
        if (c==null) return -1;
        int lht = leaf_heights(c.getLeft());
        int rht = leaf_heights(c.getRight());
